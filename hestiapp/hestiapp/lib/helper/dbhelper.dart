...
import 'package:hestiapp/models/finance.dart';
import 'package:hestiapp/constant/finance_type_constants.dart';
...
class DbHelper {
  ...
  void _createDb(Database db, int version) async {
    ...
    await db.insert("user", {'email': 'hesti@mail.com', 'password': 'hesti'});
  }
