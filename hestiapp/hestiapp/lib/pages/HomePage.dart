...
import 'package:hestiapp/helper/dbhelper.dart';
            ...
            Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    NavButton(
                        imagePath: 'assets/images/pemasukan_hesti.jpeg',
                        label: "Tambah Pemasukan",
                        onTap: () {
                          Navigator.pushNamed(context, addIncomeRoute);
                        }),
                    NavButton(
                        imagePath: 'assets/images/pengeluaran_hesti.jpeg',
                ...
                Row(
                  ...
                  children: [
                    NavButton(
                        imagePath: 'assets/images/cashflow_hesti.jpg',
                        label: "Detail Cash Flow",
                        onTap: () {
                          Navigator.pushNamed(context, detailCashFlowRoute);
                        }),
                    NavButton(
                        imagePath: 'assets/images/setting-hesti.png',
                        label: "Pengaturan",
                        onTap: () {
